...
class TestButtons:
    def _make_buttons(self, **pressed):
        ...
        defaults = dict(A=False, B=False, X=False, Y=False, LB=False, RB=False, dpad_up=False, dpad_down=False)
        ...
        b.update(defaults["A"], defaults["B"], defaults["X"], defaults["Y"],
                 defaults["LB"], defaults["RB"], defaults["dpad_up"], defaults["dpad_down"])
        return b
